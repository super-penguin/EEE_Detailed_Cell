...
######################################################
def analysis_N(Bnum = 'B34', path = "Data_06_01/"):
    level2 = level[Bnum]
        ...
        for index, js in enumerate(json_files):
            with open(os.path.join(path_to_json, js)) as json_file:
                ...
                new_data.loc[index + i*num] = [TTX, Bnum, Loc, AMPA_num, AMPA_locs, AMPA_weight,
                    NMDA_num, NMDA_locs, NMDA_weight, spike_num, platamp, ISI, platdur]
        i = i + 1
    ...
    for l2 in level2:
        ...
        for index, js in enumerate(json_files):
            with open(os.path.join(path_to_json, js)) as json_file:
                ...
                ISI = 0
                new_data.loc[index + i*num] = [TTX, Bnum, Loc, AMPA_num, AMPA_locs, AMPA_weight, NMDA_num, NMDA_locs, NMDA_weight,  spike_num, platamp, ISI, platdur]
        i = i + 1
