...
path_to_json = 'Data_04_09/Sim2/TTX'
...
#
# # ##### Plotting
df = pd.read_csv('Data_04_10/Normal/total_results.csv', index_col = 0)
df = df.sort_values(by = ['NMDA_weight'])
df_TTX = pd.read_csv('Data_04_10/No_AMPA/total_results.csv', index_col = 0)
df_TTX = df_TTX.sort_values(by = ['NMDA_weight'])
...
save(title, path_to_json, ext="ps", close=False, verbose=True)
