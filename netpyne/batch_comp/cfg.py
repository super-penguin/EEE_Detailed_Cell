...
cfg.NetStimSyn = {'pop': ['eeeD', 'eeeS'], 'loc': [cfg.synLocStart, cfg.synLocStart + cfg.synLocSpread], 'sec': 'basal_34', 'synMech': ['NMDA','AMPA'], 'start': cfg.synTime, 'interval': 1000, 'noise': 0.0, 'number': 1, 'weight': cfg.glutAmp, 'delay': cfg.synDelay}

cfg.NetStimExSyn = {'pop': ['eeeD', 'eeeS'], 'loc': [cfg.synLocStart, cfg.synLocStart + cfg.synLocSpread], 'sec': 'basal_34', 'synMech': ['NMDA'], 'start': cfg.synTime, 'interval': 1000, 'noise': 0.0, 'number': 1, 'weight': cfg.glutAmp * cfg.glutAmpExSynScale, 'delay': cfg.exSynDelay}
