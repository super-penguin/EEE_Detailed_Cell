...
cfg.NetStimSyn = {'pop': ['CA229simp'], 'loc': [cfg.synLocStart, cfg.synLocStart + cfg.synLocSpread], 'sec': 'Bdend1', 'synMech': ['NMDA','AMPA'], 'start': 100, 'interval': 1000, 'noise': 0.0, 'number': 1, 'weight': cfg.glutAmp, 'delay': cfg.synDelay}

cfg.NetStimExSyn = {'pop': ['CA229simp'], 'loc': [cfg.synLocStart, cfg.synLocStart + cfg.synLocSpread], 'sec': 'Bdend1', 'synMech': ['NMDA'], 'start': 100, 'interval': 1000, 'noise': 0.0, 'number': 1, 'weight': cfg.glutAmp * cfg.glutAmpExSynScale, 'delay': cfg.exSynDelay}
