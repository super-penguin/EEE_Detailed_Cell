...
Run simulation with NMDAeee.mod file - for comparison of NMDA.mod, NMDAeee.mod and NMDAmajor.mod
"""
from CA229 import *
...
if __name__ == "__main__":
    ...
    weight = [0.1, 0.15, 0.16, 0.17, 0.18, 0.2, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 0.9]
