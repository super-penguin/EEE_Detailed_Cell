...
new_data = new_data.sort_values(by = ['AMPA_weight'])
# print new_data
# Add the correct saving path here:
savepath = path_to_json + '/Major_total_results.csv'
...
ax.scatter(df11['AMPA_weight'], df11['platamp'], s = 200, marker = 'o',
c = tableau(0), edgecolors = tableau(14), linewidth = 2, alpha = 0.5)
ax.scatter(df12['AMPA_weight'], df12['platamp'], s = 200, marker = 'o',
...
ax.yaxis.set_ticks_position('left')
ax.xaxis.set_ticks_position('bottom')
ax.scatter(df1['AMPA_weight'], df1['platamp'], s = 200, marker = 'o',
...
ax.yaxis.set_ticks_position('left')
ax.xaxis.set_ticks_position('bottom')
ax.scatter(df1['AMPA_weight'], df1['platdur'], s = 200, marker = 'o',
c = 'white', edgecolors = tableau(6), linewidth = 2, alpha = 1)
# ax.scatter(df12['NMDA_weight'], df12['platamp'], s = 200, marker = 'o',
# c = tableau(4), edgecolors = tableau(14), linewidth = 2,alpha = 0.5)
plt.xlim([0.0, 1.0])
...
ax.yaxis.set_ticks_position('left')
ax.xaxis.set_ticks_position('bottom')
ax.scatter(df1['AMPA_weight'], df1['spike_num'], s = 200, marker = 'o',
c = 'white', edgecolors = tableau(6), linewidth = 2, alpha = 1)
# ax.scatter(df12['NMDA_weight'], df12['platamp'], s = 200, marker = 'o',
# c = tableau(4), edgecolors = tableau(14), linewidth = 2,alpha = 0.5)
plt.xlim([0.0, 1.0])
